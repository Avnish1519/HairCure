    ...
    static func checkCalorieGoal(consumed: Float, target: Float) -> CalorieCheckResult {
        ...
        if consumed < minWarn {
            ...
            return CalorieCheckResult(
                canLog: true,
                message: "You're \(needed) kcal below the recommended minimum — your hair follicles need more nutrients. You can still log this meal.",
                goalStatus: .under
            )
