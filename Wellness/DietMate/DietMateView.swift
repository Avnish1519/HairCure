...
private struct DateHeader: View {
    ...
    var body: some View {
        HStack {
            // dietMateDateTitle is a Date extension defined in DataStore (Foundation only)
...
private struct WeekRingStrip: View {
    ...
    var body: some View {
        // currentWeekDates() is defined in DataStore — no logic here
        HStack(spacing: 0) {
...
private struct WeekDayCell: View {
    ...
    var body: some View {
        ...
        let progress   = target > 0 ? min(Double(consumed / target), 1.0) : 0.0
...
private struct SectionHeading: View {
    ...
    var body: some View {
        // selectedDate.isToday is a Date extension defined in DataStore (Foundation only)
        HStack {
...
private struct MealCard: View {
    ...
    var body: some View {
        // entry.hasCalories and store.linkedFoods() are defined in DataStore
...
private struct AddMealView: View {
    ...
    var body: some View {
        // All data queries delegated to DataStore — no helper functions here
...
private struct NutritionCard: View {
    ...
    var body: some View {
        // macroDisplayInfo(value:) and macroMaxValue are Food extensions in DataStore
